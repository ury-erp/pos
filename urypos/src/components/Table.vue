<template>
  ...
  <div v-if="this.table.selectedOption === 'Table'" class="container m-auto">
    <div class="flow-root">
      <div
        ...
        >
          ...
          <div class="flex flex-col pb-4">
            ...
            <div class="mt-8 text-center" v-if="table.occupied != 1">
              <a
                class="inline-flex rounded-lg px-3 py-2 text-center text-sm font-medium  bg-blue-700 text-white"
