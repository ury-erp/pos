          ...
          <div class="mt-1">
            <div class="relative">
              <input
                ...
                required
                placeholder="•••••"
                class="block w-full appearance-none rounded-md border border-gray-300 px-3 py-2 pl-10 placeholder-gray-400 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-blue-500 sm:text-sm"
              />
              <div class="absolute inset-y-0 left-0 flex items-center px-2">
                <svg
              ...
              >
                ...
                >
                  <span v-if="this.auth.showPassword" class="text-gray-400">Hide</span>
                  <span v-else class="text-gray-400">Show</span>
                </button>
              </div>
            </div>
          </div>
